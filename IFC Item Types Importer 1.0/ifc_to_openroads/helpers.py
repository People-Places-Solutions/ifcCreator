...
def get_command_line_input():
    ...
    parser = argparse.ArgumentParser(
        description="Extract attributes from an IFC file and export as a table."
    )
...
def get_excel_tables(item_types, data_path):
    ...
    Args:
        item_types (list): A list of dictionaries, each containing item type information. Info should be in the config file.
        data_path (str): The path to the data directory.
    Returns:
        list: A list of dictionaries, each containing the item type name, library, and corresponding DataFrame.
    """
    excel_tables = []
...
def copy_xlsx_files(source_dir, dest_dir):
    """
    Args:
        source_dir (str): The source directory containing the Excel files.
        dest_dir (str): The destination directory where the Excel files will be copied.
    """
