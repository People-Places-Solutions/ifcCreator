...
def get_property_sets(in_file):
    ...
    elements = ifc_file.by_type(config.IFC_ELEMENT_TYPE)

    if not elements:
        print(f"No elements of type {config.IFC_ELEMENT_TYPE} found in the IFC file.")
        sys.exit()
